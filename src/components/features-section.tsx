...
import { Code2, Video, FileText, Trophy, Users, Brain, Timer, CheckCircle2 } from "lucide-react";
  ...
  return <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => <Card key={index} className="card-hover border-0 shadow-md bg-card/50 backdrop-blur">
              ...
              <CardContent>
                <div className="space-y-2">
                  {feature.highlights.map((highlight, idx) => <div key={idx} className="flex items-center space-x-2">
